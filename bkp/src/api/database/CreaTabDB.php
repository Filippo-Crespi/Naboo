...
$sql = 'CREATE TABLE IF NOT EXISTS Moduli (
    ...
    FOREIGN KEY (IDF_Utente) REFERENCES Utenti(ID_Utente)
);';
...
$sql = 'CREATE TABLE IF NOT EXISTS Sezioni (
    ...
    Nome VARCHAR(30) NOT NULL,
    FOREIGN KEY (IDF_Modulo) REFERENCES Moduli(ID_Modulo)
)';
...
$sql = 'CREATE TABLE IF NOT EXISTS Domande (
    ...
    Testo TEXT NOT NULL,
    Descrizione TEXT,
    FOREIGN KEY (IDF_Sezione) REFERENCES Sezioni(ID_Sezione),
    FOREIGN KEY ( IDF_Modulo) REFERENCES Moduli(ID_Modulo),
    FOREIGN KEY (IDF_Tipologia) REFERENCES Tipologie(ID_Tipologia)
)';
...
$sql = 'CREATE TABLE IF NOT EXISTS Risposte (
    ...
    FOREIGN KEY (IDF_Domanda) REFERENCES Domande(ID_Domanda)
)';
...
$sql = 'CREATE TABLE IF NOT EXISTS DettRisultati(
    ...
    FOREIGN KEY (IDF_Risultato) REFERENCES Risultati(ID_Risultato),
    FOREIGN KEY (IDF_Risposta) REFERENCES Risposte(ID_Risposta)
)';
